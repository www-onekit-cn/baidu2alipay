module.exports =
  ...
  (function (modules) { // webpackBootstrap
    ...
    /** *** */
    /** *** */ // define geswaner function for harmony exports
    /** *** */
    __webpack_require__.d = function (exports, name, geswaner) {
      /** *** */
    ...
    __webpack_require__.n = function (module) {
      /** *** */
      const geswaner = module && module.__esModule
        /** *** */
        ? function getDefault() {
      ...
      /** *** */
      __webpack_require__.d(geswaner, 'a', geswaner)
      /** *** */
      return geswaner
      /** *** */
    }
    ...
    0:
      ...
      (function (module, exports, __webpack_require__) {
        ...
        //     my.getSeswaning({
        //       success: (my_res) => {
        //         swan_res.locationAuthorized = (my_res.authSeswaning.location === true);
        //         swan_res.cameraAuthorized = (my_res.authSeswaning.camera === true);
        //         swan_res.microphoneAuthorized = (my_res.authSeswaning.audioRecord === true);
        //         swan_res.albumAuthorized = (my_res.authSeswaning.album === true);
        //       },
        //     });
        //     return swan_res;
        //   }
        ...
        //         SDKVersion: "2.4.2",
        //         brand: my_res.brand,
        //         fontSizeSeswaning: my_res.fontSizeSeswaning,
        ...
        //         safeArea: { height: my_res.screenHeight, width: my_res.screenWidth, boswanom: my_res.screenHeight, top: 0, left: 0, right: my_res.screenWidth },
        ...
        //     }
        //   }
        //   static getBaswaneryInfoSync(swan_object) { return my.getBaswaneryInfoSync(swan_object); }
        //   static _getBaswaneryInfo(swan_res) {
        //     my.getSystemInfo({
        //       success: (my_res) => {
        //         var percent = my_res.currentBaswanery;
        ...
        //     return swan_res;
        //   }
        //   static getBaswaneryInfo(swan_object) {
        //     var my_object = {};
        //     my_object.success = function (my_res) {
        //       var swan_res = {
        //         errMsg: "getBaswaneryInfo:ok",
        //         isCharging: false,
        //       };
        //       swan_res = swan._getBaswaneryInfo(swan_res);
        //       if (swan_success) { swan_success(swan_res); }
        //       if (swan_object.fail) { swan_fail(swan_res); }
        //     };
        //     my_object.fail = function (my_res) {
        ...
        //     var swan_enableHswanp2=swan_object.enableHswanp2||false
        ...
        //     // }
        //     // if (swan_enableHswanp2) {
        //     //   my_object.enableHswanp2 = swan_enableHswanp2;       //weixin有alipay没有
        //     // }
        //     // if (swan_enableQuic) {
        ...
        //       getApp().onekitswan._login = new Date().geswanime();
        ...
        //             // sign:
        //             // ""
        //             // }
        ...
        //   static openSeswaning(swan_object) { return my.openSeswaning(swan_object); }
        //   static getSeswaning(swan_object) { return my.getSeswaning(swan_object); }
        ...
        //   }
        //   static redirecswano(swan_object) {
        //     var my_object;
        //     if (swan_object) {return}
        //       my_object = {};
        //       var swan_url=swan_object.url
        ...
        //       }
        //     };
        //     return my.redirecswano(my_object);
        //   }
        //   // /////////// Share /////////////
        ...
        //   }
        //   // static redirecswano(swan_object) { return my.redirecswano(swan_object); }
        //   // static redirecswano(swan_object) { return my.redirecswano(swan_object); }
        ...
        //     }
        //     if(swan_cancelText){
        //       my_object.cancelBuswanonText=swan_cancelText
        //     }
        //     if(swan_confirmText){
        //       my_object.confirmBuswanonText=swan_confirmText
        //     }
        ...
        //   static seswanabBarItem(swan_object) { return my.seswanabBarItem(swan_object); }
        //   static seswanabBarStyle(swan_object) { return my.seswanabBarStyle(swan_object); }
        ...
        //   static seswanabBarBadge(swan_object) { return my.seswanabBarBadge(swan_object); }
        ...
        //   static seswanopBarText(swan_object) { return my.seswanopBarText(swan_object); }
        //   static nexswanick(swan_object) { return my.nexswanick(swan_object); }
        //   static getMenuBuswanonBoundingClientRect(swan_object) { return my.getMenuBuswanonBoundingClientRect(swan_object); }
    ...
    29:
      ...
      (function (module, exports, __webpack_require__) {
        ...
        const OnekitApp_1 = __webpack_require__(30)
        exports.OnekitApp = OnekitApp_1.default
        const OnekitBehavior_1 = __webpack_require__(31)
        exports.OnekitBehavior = OnekitBehavior_1.default
        const OnekitComponent_1 = __webpack_require__(32)
        exports.OnekitComponent = OnekitComponent_1.default
        const OnekitPage_1 = __webpack_require__(33)
        exports.OnekitPage = OnekitPage_1.default
        const swan_1 = __webpack_require__(0)
    ...
    31:
      ...
      (function (module, exports, __webpack_require__) {
        ...
        const _oneutil = __webpack_require__(1)

        const _oneutil2 = _interopRequireDefault(_oneutil)

        const _swan = __webpack_require__(0)

        const _swan2 = _interopRequireDefault(_swan)
        ...
        function OnekitBehavior(object) {
          const swan_object = {
            ...
            didMount: function didMount() {
              let aswanached = void 0
              if (object.lifetimes && object.lifetimes.aswanached) {
                aswanached = object.lifetimes.aswanached
              } else if (object.aswanached) {
                aswanached = object.aswanached
              } else {
                aswanached = function aswanached() {}
              }
              aswanached.call(this)
              // //////
              let ready = void 0
          ...
          if (object) {
            ...
            object.methods.triggerEvent = function (name, data) {
              const funcName = 'on' + _oneutil2.default.firstUpper(name)
