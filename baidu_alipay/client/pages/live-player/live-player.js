...
Page({
    ...
    objectFit(e) {
        swan.setData(this,'objectFit', swan.getData(this,'objectFit') === 'contain' ? 'fillCrop' : 'contain');
    },
    liveStop(e) {
        swan.showToast({
    ...
    liveMute(e) {
        ...
        let muted = !swan.getData(this,'muted');
        swan.setData(this,'muted', muted);
    },
    changeSrc(e) {
        swan.showToast({
            title: '更换 src:' + swan.getData(this,'src')
        });
        let srcList = swan.getData(this,'srcList');
        let cur = (swan.getData(this,'cur') + 1) % srcList.length;
        swan.setData(this,'src', srcList[cur]);
        swan.setData(this,'cur', cur);
    },
    backgroundMute(e) {
        swan.setData(this,'backgroundMute', !swan.getData(this,'backgroundMute'));
        swan.showToast({
            title: swan.getData(this,'backgroundMute')
        });
    },
    changeFull(e) {
